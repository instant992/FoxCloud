...
#include <flowvy_notification/flowvy_notification_plugin_c_api.h>
...
void RegisterPlugins(flutter::PluginRegistry* registry) {
  ...
  FlowvyNotificationPluginCApiRegisterWithRegistrar(
      registry->GetRegistrarForPlugin("FlowvyNotificationPluginCApi"));
